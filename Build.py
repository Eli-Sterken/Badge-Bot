...
Version = "1.0.0 beta"
Year = "2024"
Git_Link = "https://github.com/Eli-Sterken/Badge-Bot"
Bot_Token = ""
Client_ID = ""
...
def Build(): # Function to build the bot
    ...
    print("\n"
          "Bot termanated. Thank you for using Badge Bot.") # Once the bot shuts down, print a message and quit
    quit()

print( "\n"
      f"Badge Bot Copyright (C) {Year} Eli Sterken"
       "\n"
